...
const Regalos_Card = ({ id, image, title, isHorizontal }) => {
  ...
  return (
    <div className={`regalos-card ${isHorizontal ? 'regalos-card--horizontal' : ''}`} onClick={handleButtonClick}>
      ...
      <div className="regalos-card-info">
        ...
        <button className="regalos-card-button" onClick={handleButtonClick}>
          Ver Detalles
        </button>
      </div>
    </div>
