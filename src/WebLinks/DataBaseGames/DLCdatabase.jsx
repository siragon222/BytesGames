...
export const dlcGames = [
  {
    ...
    editions: {
      PlayStation: {
        Común: { price: 20.99, description: 'Incluye el DLC base para PlayStation.' },
        Estándar: { price: 50.99, description: 'Incluye el DLC base + contenido adicional para PlayStation.' },
        Premium: { price: 89.99, description: 'Incluye el DLC base + contenido adicional + DLCs exclusivos para PlayStation.' },
      },
      PS4: {
        Común: { price: 25.00, description: 'Incluye el DLC base para PS4.' },
        Estándar: { price: 55.00, description: 'Incluye el DLC base + contenido adicional para PS4.' },
        Premium: { price: 95.00, description: 'Incluye el DLC base + contenido adicional + DLCs exclusivos para PS4.' },
      },
      PS5: {
        Común: { price: 30.00, description: 'Incluye el DLC base para PS5.' },
        Estándar: { price: 60.00, description: 'Incluye el DLC base + contenido adicional para PS5.' },
        Premium: { price: 100.00, description: 'Incluye el DLC base + contenido adicional + DLCs exclusivos para PS5.' },
      },
      PC: {
        Común: { price: 29.99, description: 'Incluye el DLC base para PC.' },
      }
    },
    ...
    licensePrices: {
      ...
      PC: {
        Principal: { price: 25.00, description: 'Licencia principal para una cuenta en PC.' },
      }
    },
  ...
  },
  {
    ...
    editions: {
      ...
      PS5: {
        Común: { price: 20.00, description: 'DLC Wrath of the Druids base para PS5.' },
      },
      PC: {
        Común: { price: 19.99, description: 'DLC Wrath of the Druids base para PC.' },
      }
    },
    ...
    licensePrices: {
      ...
      PS4: {
        Principal: { price: 8.00, description: 'Licencia principal para una cuenta.' },
      },
      PS5: {
        Principal: { price: 10.00, description: 'Licencia principal para una cuenta.' },
      },
      PC: {
        Principal: { price: 15.00, description: 'Licencia principal para una cuenta en PC.' },
      }
    },
    fotos: [
      'https://i.ibb.co/cHHGhNq/Assassin-s-Creed-Valhalla-5-1-11zon.webp',
  ...
  },
  {
    ...
    editions: {
      PlayStation: {
        Común: { price: 18.99, description: 'DLC The Siege of Paris base.' },
      },
      PS4: {
        Común: { price: 20.00, description: 'DLC The Siege of Paris base para PS4.' },
      },
      PS5: {
        Común: { price: 22.00, description: 'DLC The Siege of Paris base para PS5.' },
      },
      PC: {
        Común: { price: 24.99, description: 'DLC The Siege of Paris base para PC.' },
      }
    },
    ...
    licensePrices: {
      ...
      PS4: {
        Principal: { price: 9.00, description: 'Licencia principal para una cuenta.' },
      },
      PS5: {
        Principal: { price: 11.00, description: 'Licencia principal para una cuenta.' },
      },
      PC: {
        Principal: { price: 19.00, description: 'Licencia principal para una cuenta en PC.' },
      }
    },
    fotos: [
      'https://i.ibb.co/84tNbvf4/Assassin-s-Creed-Valhalla-4-2-11zon.webp',
  ...
  },
  {
    ...
    editions: {
      ...
      PS5: {
        Común: { price: 40.00, description: 'DLC Dawn of Ragnarök base para PS5.' },
      },
      PC: {
        Común: { price: 39.99, description: 'DLC Dawn of Ragnarök base para PC.' },
      }
    },
    ...
    licensePrices: {
      ...
      PS4: {
        Principal: { price: 15.00, description: 'Licencia principal para una cuenta.' },
      },
      PS5: {
        Principal: { price: 20.00, description: 'Licencia principal para una cuenta.' },
      },
      PC: {
        Principal: { price: 30.00, description: 'Licencia principal para una cuenta en PC.' },
      }
    },
    fotos: [
      'https://i.ibb.co/60Pf5FSS/Assassin-s-Creed-Valhalla-1-1-11zon.webp',
